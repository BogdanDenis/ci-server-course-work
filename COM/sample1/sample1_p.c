...
typedef struct _sample1_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } sample1_MIDL_TYPE_FORMAT_STRING;

typedef struct _sample1_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } sample1_MIDL_PROC_FORMAT_STRING;

typedef struct _sample1_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } sample1_MIDL_EXPR_FORMAT_STRING;
...
extern const sample1_MIDL_TYPE_FORMAT_STRING sample1__MIDL_TypeFormatString;
extern const sample1_MIDL_PROC_FORMAT_STRING sample1__MIDL_ProcFormatString;
extern const sample1_MIDL_EXPR_FORMAT_STRING sample1__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ICGreet_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ICGreet_ProxyInfo;
...
static const sample1_MIDL_PROC_FORMAT_STRING sample1__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 172 */	NdrFcShort( 0x26 ),	/* Type Offset=38 */
...
static const sample1_MIDL_TYPE_FORMAT_STRING sample1__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: ICGreet, ver. 0.0,
   GUID={0x1638ED3E,0x43E1,0x11D6,{0x89,0xB2,0x00,0x01,0x03,0x02,0x15,0x8B}} */

#pragma code_seg(".orpc")
static const unsigned short ICGreet_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ICGreet_ProxyInfo =
    {
    &Object_StubDesc,
    sample1__MIDL_ProcFormatString.Format,
    &ICGreet_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ICGreet_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    sample1__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(11) _ICGreetProxyVtbl = 
{
    &ICGreet_ProxyInfo,
    &IID_ICGreet,
    ...
    (void *) (INT_PTR) -1 /* ICGreet::SayHello */ ,
    (void *) (INT_PTR) -1 /* ICGreet::WORKDIR */ ,
    (void *) (INT_PTR) -1 /* ICGreet::COPY */ ,
    (void *) (INT_PTR) -1 /* ICGreet::RUN */
};


static const PRPC_STUB_FUNCTION ICGreet_table[] =
{
...
CInterfaceStubVtbl _ICGreetStubVtbl =
{
    &IID_ICGreet,
    &ICGreet_ServerInfo,
    11,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    sample1__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _sample1_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICGreetProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _sample1_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICGreetStubVtbl,
    0
};

PCInterfaceName const _sample1_InterfaceNamesList[] = 
{
    "ICGreet",
    0
};

const IID *  const _sample1_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _sample1_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _sample1, pIID, n)

int __stdcall _sample1_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_sample1_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo sample1_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _sample1_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _sample1_StubVtblList,
    (const PCInterfaceName * ) & _sample1_InterfaceNamesList,
    (const IID ** ) & _sample1_BaseIIDList,
    & _sample1_IID_Lookup, 
    1,
    2,
